...
void CharacterSelect()
{
    ...
    {
        Console.Clear();
        Console.Write("==============================================================\nKérem adjon meg egy játékos ikont (billentyűzet karakter): ");
...
void CombatEnemy()
{
    ...
    int enemyRoundHealth = enemy.Health;
    int enemyRoundEnergy = enemy.Energy;
    ...
    while (true)
    {
        ...
        {
            //case 1:
            //    enemyDamageDeal = MovePunch(0, enemyPunchLVL, enemyRoundEnergy, enemyFlexBonus);
            //    roundEnergy -= 5;
            //    enemyFlexBonus = 0;
            //    enemyLastMove = $"Az ellenfél {enemyDamageDeal} pontot sebzett";
            //    break;
            //case 2:
            //    enemyDamageBlock = MoveBlock(0, enemyBlockLVL, enemyRoundEnergy);
            //    enemyRoundEnergy -= 5;
            //    enemyLastMove = $"Az ellenfél {enemyDamageBlock} pontot blokkolt";
            //    break;
            //case 3:
            //    enemyDodge = MoveDodge(0, enemyDodgeLVL, enemyRoundEnergy);
            //    enemyRoundEnergy += 5;
            //    if (enemyDodge)
            //    {
            ...
            //    break;
            //case 4:
            //    enemyFlexBonus = MoveFlex(0, enemyFlexLVL, enemyRoundEnergy);
            //    enemyRoundEnergy += 5;
            //    enemyLastMove = $"Az ellenfél {enemyFlexBonus} pontot flexelt";
            //    break;
        }
